...
<body>
    <div class="container">
        ...
        <div class="important-info">
            ...
            <p>Le informamos que su inconformidad: <strong>{{ $queja->motivo }}</strong> y con número de folio: <strong>{{ $queja->id }}</strong> a sido resuelta, muchas gracias por la confianza y espera.</p>
